...
impl ProviderAdmin for UnusedProvider {
    ...
    async fn start_authorization(
        &self,
        _: gateway_admin::model::provider_credentials::PrepareAuthorization,
    ...
    async fn poll_authorization(
        &self,
        _: gateway_admin::model::provider_credentials::PollAuthorization,
    ) -> Result<
    ...
    > {
        ...
        Ok(
            gateway_admin::model::provider_credentials::PreparedAuthorizationPoll::Pending {
                retry_after: std::time::Duration::from_millis(1250),
            },
        )
    }
