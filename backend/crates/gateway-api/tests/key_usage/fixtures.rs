...
use gateway_admin::model::{
    ...
    observability::{
        AttemptMetrics, CostCoverage, CurrencyCost, DecimalAmount, DiagnosticObservation,
        Granularity, OpsError, RequestMetricPoint, RequestMetrics, TimeRange, UsageBilling,
        UsageListRecord, UsageOverview,
    },
};
use gateway_core::{
